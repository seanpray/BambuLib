...
// default: unknown
const std::map<int, std::string> ACTION_IDS = {
    { 0, "printing" },
    { 1, "auto_bed_leveling" },
    { 2, "heatbed_preheatin," },
...
const std::map<int, std::string> SPEED_PROFILE = {
    { 1, "silent" },
    { 2, "standard" },
    { 3, "sport" },
    { 4, "ludicrous " }
...
const std::map<std::string, std::string> FILAMENT_NAMES = {
    { "default", "Unknown" },
    { "GFB00", "Bambu ABS" },
    { "GFB01", "Bambu ASA" },
    { "GFN03", "Bambu PA-CF" },
...
const std::map<std::string, std::string> HMS_ERRORS = {
